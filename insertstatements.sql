...
insert into groups values('a', 'Bluegrass Musicians', 'Music', 27708, 'private', 'Looking for a bass player -- auditions coming soon!');
insert into groups values('b', 'Animal Lovers', 'Animals', 27708, 'public', 'We stalk Nugget and post updates about where she is');
insert into groups values('c', 'Any games for fun!', 'Games', 27708, 'private', 'Board game fans at Duke, raise your hands!');
insert into groups values('d', 'PATRIOTS FANS ONLY', 'Sports', 27705, 'public', 'Duke football game watch parties');
insert into groups values('e', 'Trivial Players', 'Nightlife', 27708, 'public', 'We attend Krafthouse Trivia night every Thursday night at 8pm!');
