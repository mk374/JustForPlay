...
try:
   ...
   for i in range(1000):
       ...
       rbio = 'My name is ' + name + ' and I like ' + random.choice[snacks] + '.'
       rzipcode = random.choice(zips)
       temp = (rname, ruid, rpassword, rbio, rzipcode)
       users.append(temp)

   for item in users:
        postgres_insert_query = """ INSERT INTO ruser (uid, name, password, bio, zip_code) VALUES (%s,%s,%s, %s, %d)"""
